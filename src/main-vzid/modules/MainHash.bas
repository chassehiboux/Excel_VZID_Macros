...
Public Function MainHash_FileSha256Hex(ByVal filePath As String) As String
...
#End If
    ...
    For index = 0 To hashLength - 1
        MainHash_FileSha256Hex = MainHash_FileSha256Hex & LCase$(Right$("0" & Hex$(hashBytes(index)), 2))
    Next index

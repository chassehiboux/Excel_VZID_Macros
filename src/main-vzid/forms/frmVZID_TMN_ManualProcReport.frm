VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmVZID_TMN_ManualProcReport 
   Caption         =   "ТЮМЕНЬ (Отчет ручной обработки)"
   ClientHeight    =   10410
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   13575
   OleObjectBlob   =   "frmVZID_TMN_ManualProcReport.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmVZID_TMN_ManualProcReport"
...
Private Const TARGET_FILE As String = "\\corp.vostok-electra.ru\Tmn\Общая\ОВЗИД\Зуйкевич\ВЗИД\Отчет ручной обработки\Отчет ручной обработки Тюмень.xlsx"
...
Private Function LockFilePath() As String
    Dim f As String
    f = TARGET_FILE
    LockFilePath = Left$(f, InStrRev(f, "\")) & "Отчет ручной обработки Тюмень.xlsx.lck"
End Function
